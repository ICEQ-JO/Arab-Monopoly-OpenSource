...
// Layout convention (since the board structure pass): the 4 corners (ids 0, 8,
// 16, 24 -- see Board.jsx's getGridPos) hold the 4 non-property "big" tiles
// (Start, Holding, Rest, Go-to-Holding), mirroring classic Go/Jail/Free-Parking
// /Go-To-Jail corner placement. Within each side, every color group's tiles are
// kept contiguous (never split by a non-property tile); non-property tiles
// (treasure/surprise/tax/transit/utility) sit only *between* groups, acting as
// separators, never inside one.
export const BOARD = [
  ...
  { id: 2, type: TILE_TYPES.PROPERTY, name: "Foundry Lane", group: "copper", price: 60, rent: COLOR_GROUPS.copper.rentLevels, housePrice: COLOR_GROUPS.copper.housePrice },
  { id: 3, type: TILE_TYPES.TRANSIT, name: "Harbor Station", price: 150, rent: [25, 50, 100, 200] },
  { id: 4, type: TILE_TYPES.PROPERTY, name: "Teal Quay", group: "teal", price: 100, rent: COLOR_GROUPS.teal.rentLevels, housePrice: COLOR_GROUPS.teal.housePrice },
  { id: 5, type: TILE_TYPES.PROPERTY, name: "Lagoon Walk", group: "teal", price: 100, rent: COLOR_GROUPS.teal.rentLevels, housePrice: COLOR_GROUPS.teal.housePrice },
  { id: 6, type: TILE_TYPES.PROPERTY, name: "Mariner Ave", group: "teal", price: 120, rent: COLOR_GROUPS.teal.rentLevels, housePrice: COLOR_GROUPS.teal.housePrice },
  { id: 7, type: TILE_TYPES.SURPRISE, name: "Surprise" },
  { id: 8, type: TILE_TYPES.HOLDING, name: "Holding Pen" },
  { id: 9, type: TILE_TYPES.PROPERTY, name: "Violet Court", group: "violet", price: 140, rent: COLOR_GROUPS.violet.rentLevels, housePrice: COLOR_GROUPS.violet.housePrice },
  { id: 10, type: TILE_TYPES.PROPERTY, name: "Amethyst Sq", group: "violet", price: 140, rent: COLOR_GROUPS.violet.rentLevels, housePrice: COLOR_GROUPS.violet.housePrice },
  { id: 11, type: TILE_TYPES.PROPERTY, name: "Orchid Blvd", group: "violet", price: 160, rent: COLOR_GROUPS.violet.rentLevels, housePrice: COLOR_GROUPS.violet.housePrice },
  { id: 12, type: TILE_TYPES.TREASURE, name: "Treasure Chest" },
  { id: 13, type: TILE_TYPES.PROPERTY, name: "Jade Summit", group: "jade", price: 300, rent: COLOR_GROUPS.jade.rentLevels, housePrice: COLOR_GROUPS.jade.housePrice },
  ...
  { id: 17, type: TILE_TYPES.PROPERTY, name: "Amber Heights", group: "amber", price: 180, rent: COLOR_GROUPS.amber.rentLevels, housePrice: COLOR_GROUPS.amber.housePrice },
  ...
  { id: 22, type: TILE_TYPES.PROPERTY, name: "Scarlet Way", group: "crimson", price: 220, rent: COLOR_GROUPS.crimson.rentLevels, housePrice: COLOR_GROUPS.crimson.housePrice },
  { id: 23, type: TILE_TYPES.PROPERTY, name: "Ruby Terrace", group: "crimson", price: 240, rent: COLOR_GROUPS.crimson.rentLevels, housePrice: COLOR_GROUPS.crimson.housePrice },
  ...
  { id: 27, type: TILE_TYPES.PROPERTY, name: "Azure Crescent", group: "azure", price: 260, rent: COLOR_GROUPS.azure.rentLevels, housePrice: COLOR_GROUPS.azure.housePrice },
  { id: 28, type: TILE_TYPES.PROPERTY, name: "Cobalt Pier", group: "azure", price: 260, rent: COLOR_GROUPS.azure.rentLevels, housePrice: COLOR_GROUPS.azure.housePrice },
