...
// face placement: front=1, back=6, right=2, left=5, top=3, bottom=4
...
function Die3D({ value, rollSeq }) {
  ...
  return (
    <div className="die3d">
      ...
      >
        <div className="die3d-face die3d-front"><Pips value={1} /></div>
        <div className="die3d-face die3d-back"><Pips value={6} /></div>
        <div className="die3d-face die3d-right"><Pips value={2} /></div>
        <div className="die3d-face die3d-left"><Pips value={5} /></div>
        <div className="die3d-face die3d-top"><Pips value={3} /></div>
        <div className="die3d-face die3d-bottom"><Pips value={4} /></div>
      </div>
    </div>
  );
}
 ...
 *   rollSeq  — increment this number to trigger the spin animation.
 */
